...
public:
  ...
  : m_width(width), m_height(height)
  {
    ...
    m_convert_ctx = sws_getContext(m_width, m_height, AV_PIX_FMT_YUV420P, m_width, m_height, PIX_FMT_RGB24, SWS_FAST_BILINEAR, NULL, NULL, NULL);
